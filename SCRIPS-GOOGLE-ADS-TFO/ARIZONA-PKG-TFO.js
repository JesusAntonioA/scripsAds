...
const CAMPAIGN_NAME = 'ARIZONA-PKG-TFO';
const AD_GROUP_NAME = 'TFO-ARIZONA-ESTANDAR';
...
function main() {
  ...
  const filteredOffers = offers.filter(offer => offer.departure === 'PHX');
...
function createAdText(offer) {
  ...
  return {
    ...
    cost: cost,
    headlines: [
      truncateText(`Fly from Arizona to Cancun`, 30),
    ...
    descriptions: [
      truncateText(`Flight from Arizona to Cancun from $${cost}. Book Today!`, 90),
