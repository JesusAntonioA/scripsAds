...
const CAMPAIGN_NAME = 'VIRGINIA-PKG-TFO';
const AD_GROUP_NAME = 'TFO-VIRGINIA-ESTANDAR';
...
function main() {
  ...
  const filteredOffers = offers.filter(offer => offer.departure === 'IAD');
...
function createAdText(offer) {
  ...
  return {
    ...
    cost: cost,
    headlines: [
      truncateText(`Fly from Virginia to Cancun`, 30),
    ...
    descriptions: [
      truncateText(`Flight from Virginia to Cancun from $${cost}. Book Today!`, 90),
