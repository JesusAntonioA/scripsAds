...
const CAMPAIGN_NAME = 'FLORIDA-PKG-TFO';
const AD_GROUP_NAME = 'TFO-FLORIDA-ESTANDAR';
...
function main() {
  ...
  const filteredOffers = offers.filter(offer => offer.departure === 'MIA');
...
function createAdText(offer) {
  ...
  return {
    ...
    cost: cost,
    headlines: [
      truncateText(`Fly from Florida to Cancun`, 30),
    ...
    descriptions: [
      truncateText(`Flight from Florida to Cancun from $${cost}. Book Today!`, 90),
