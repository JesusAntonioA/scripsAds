...
const CAMPAIGN_NAME = 'TFD-MARYLAND-PKG';
const AD_GROUP_NAME = 'TFD-MARYLAND-ESTANDAR';
...
function main() {
  ...
  const filteredOffers = offers.filter(offer => offer.departure === 'BWI');
...
function createAdText(offer) {
  ...
  return {
    ...
    cost: cost,
    headlines: [
      truncateText(`Fly from Maryland to Cancun`, 30),
    ...
    descriptions: [
      truncateText(`Flight from Maryland to Cancun from $${cost}. Book Today!`, 90),
