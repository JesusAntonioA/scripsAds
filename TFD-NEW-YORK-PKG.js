...
const CAMPAIGN_NAME = 'TFD-NEW-YORK-PKG';
const AD_GROUP_NAME = 'TFD-NY-ESTANDAR';
...
function main() {
  ...
  const filteredOffers = offers.filter(offer => offer.departure === 'NYC');
...
function createAdText(offer) {
  ...
  return {
    ...
    cost: cost,
    headlines: [
      truncateText(`Fly from Nueva York to Cancun`, 30),
    ...
    descriptions: [
      truncateText(`Flight from Nueva York to Cancun from $${cost}. Book Today!`, 90),
