...
const CAMPAIGN_NAME = 'TFD-GEORGIA-PKG';
const AD_GROUP_NAME = 'TFD-GEORGIA-ESTANDAR';
...
function main() {
  ...
  const filteredOffers = offers.filter(offer => offer.departure === 'ATL');
...
function createAdText(offer) {
  ...
  return {
    ...
    cost: cost,
    headlines: [
      truncateText(`Fly from Georgia to Cancun`, 30),
    ...
    descriptions: [
      truncateText(`Flight from Georgia to Cancun from $${cost}. Book Today!`, 90),
