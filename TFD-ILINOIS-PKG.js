...
const CAMPAIGN_NAME = 'TFD-ILINOIS-PKG';
const AD_GROUP_NAME = 'TFD-ILINOIS-ESTANDAR';
...
function main() {
  ...
  const filteredOffers = offers.filter(offer => offer.departure === 'CHI');
...
function createAdText(offer) {
  ...
  return {
    ...
    cost: cost,
    headlines: [
      truncateText(`Fly from Illinois to Cancun`, 30),
    ...
    descriptions: [
      truncateText(`Flight from Illinois to Cancun from $${cost}. Book Today!`, 90),
