...
const CAMPAIGN_NAME = 'TFD-PK-USA-TEXAS';
const AD_GROUP_NAME = 'TFD-TEXAS-ESTANDAR';
...
function main() {
  ...
  const filteredOffers = offers.filter(offer => offer.departure === 'IAH');
...
function createAdText(offer) {
  ...
  return {
    ...
    cost: cost,
    headlines: [
      truncateText(`Fly from Texas to Cancun`, 30),
    ...
    descriptions: [
      truncateText(`Flight from Texas to Cancun from $${cost}. Book Today!`, 90),
